...
<div id="toast" class="fixed top-4 right-4 z-50 transform transition-transform duration-300 translate-x-full">
    <div class="rounded-lg shadow-lg p-4 max-w-sm w-full
        ...
        <div class="flex items-center">
            ...
            <div class="ml-3">
                <p class="text-sm ${toastType == 'error' ? 'text-red-800' : toastType == 'success' ? 'text-green-800' : 'text-blue-800'}">
                    ${toastMessage}
                </p>
            </div>
